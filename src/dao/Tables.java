...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //      st.executeUpdate("insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address)values('Admin','Iresha Thilini','1999.05.20','0783796522','iresha@gmail.com','iresha','iresha1#','Kalutara')");
           ...
           st.executeUpdate("create table bill(bill pk int AUTO INCREMENT primary key,billId varchar (200),billDate varchar(50),totalPaid bigint,generatedBy varchar(50))");
